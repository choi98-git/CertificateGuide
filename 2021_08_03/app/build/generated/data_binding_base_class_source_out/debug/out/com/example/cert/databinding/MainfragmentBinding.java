...
public final class MainfragmentBinding implements ViewBinding {
  ...
  private MainfragmentBinding(@NonNull LinearLayout rootView) {
  ...
  public static MainfragmentBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.mainfragment, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  public static MainfragmentBinding bind(@NonNull View rootView) {
    ...
    return new MainfragmentBinding((LinearLayout) rootView);
  }
}
